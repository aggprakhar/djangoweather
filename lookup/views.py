...
def home(request):
    ...
    if request.method == "POST":
        ...
        api_request = requests.get("http://api.openweathermap.org/data/2.5/weather?q=London,uk&APPID=bbe74166a0b2e5eda72860dbfaed3227")

        #api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=5&API_KEY=1D6567E5-473F-47CF-A274-75CCC2FAB25D")
        ...
        api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=85281&distance=5&API_KEY=1D6567E5-473F-47CF-A274-75CCC2FAB25D")
